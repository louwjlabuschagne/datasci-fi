...
load("data/my_twitteR_oauth.RData") 
...
```{r}
library(ROAuth)
api_key <- "k8watBxREVNwUu9ToBz4hXDjM"
api_secret <- "1baMejdgNwRpJ0kpwxdTTusSANBurGkfIPGxTkrKKsULcAygCu"
access_token <- "4877340509-QY60fJZCSOAUAqjqqCjE6c0P2CrP8Jhv6AtCKco"
access_token_secret <- "KuaLjI5orzoGOIRGAvw1okUI6aKgcFC9TMcN39UzyXuZ4"
```
...
save(my_oauth, file = "/Users/louwrenslabuschagne/Documents/MScDataScience/STA5073ZDataScienceForIndustry/classNotes/datasci-fi/data/my_oauth.Rdata")
```
